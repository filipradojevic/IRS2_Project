...
//Clients enums for returning values of functions
typedef enum{
	UNINITIALIZED_OLED_INIT = 0,
	INITIALIZED_OLED_INIT_SUCCESSFULLY,
} SSD1306_OLED_INIT_T;

typedef enum{
	UNINITIALIZED_OLED_CURSOR = 0,
	INITIALIZED_OLED_CURSOR_SUCCESSFULLY,
} SSD1306_OLED_CURSOR_T;

typedef enum{
	UNINITIALIZED_OLED_UPDATE_SCREEN = 0,
	INITIALIZED_OLED_UPDATE_SCREEN_SUCCESSFULLY,
} SSD1306_OLED_UPRDATE_SCREEN_T;
