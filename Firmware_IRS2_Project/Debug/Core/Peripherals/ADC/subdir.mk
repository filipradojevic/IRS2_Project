...
C_SRCS += \
../Core/Peripherals/ADC/adc.c 

OBJS += \
./Core/Peripherals/ADC/adc.o 

C_DEPS += \
./Core/Peripherals/ADC/adc.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Peripherals/ADC/%.o Core/Peripherals/ADC/%.su Core/Peripherals/ADC/%.cyclo: ../Core/Peripherals/ADC/%.c Core/Peripherals/ADC/subdir.mk
...
clean: clean-Core-2f-Peripherals-2f-ADC

clean-Core-2f-Peripherals-2f-ADC:
	-$(RM) ./Core/Peripherals/ADC/adc.cyclo ./Core/Peripherals/ADC/adc.d ./Core/Peripherals/ADC/adc.o ./Core/Peripherals/ADC/adc.su

.PHONY: clean-Core-2f-Peripherals-2f-ADC
