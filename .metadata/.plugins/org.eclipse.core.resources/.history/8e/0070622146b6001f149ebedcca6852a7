...
//My enum for initialization
typedef enum{
	UNITIALIZED_OLED_INIT = 0,
	INITIALIZED_OLED_INIT_UNSUCCESSFULLY,
	INITIALIZED_OLED_INIT_SUCCESSFULLY,
} OLED_Init_t;

typedef enum{
	UNITIALIZED_OLED_CURSOR_ = 0,
	INITIALIZED_OLED_CURSOR_UNSUCCESSFULLY,
	INITIALIZED_OLED_CURSOR_SUCCESSFULLY,
}OLED_SetCursor_t;

typedef enum{
	UNITIALIZED_OLED_WRITE_STRING = 0,
	INITIALIZED_OLED_WRITE_STRING_UNSUCCESSFULLY,
	INITIALIZED_OLED_WRITE_STRING_SUCCESSFULLY,
}OLED_WriteString_t;

typedef enum{
	UNITIALIZED_OLED_UPDATE_SCREEN = 0,
	INITIALIZED_OLED_UPDATE_SCREEN_UNSUCCESSFULLY,
	INITIALIZED_OLED_UPDATE_SCREEN_SUCCESSFULLY,
}OLED_UpdateScreen_t;
